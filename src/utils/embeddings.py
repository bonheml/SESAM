...
def load_embeds(text_embed, img_embed):
...
def retrieve_all_embeds(to_retrieve):
    ...
    for sent_embed_file, img_embed_file in to_retrieve:
        sent_embed, img_embed, concat_embed = load_embeds(sent_embed_file, img_embed_file)
